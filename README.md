# FlatheadMobileBasketball

Notes on a possible mobile arcade basketball trailer business in the Flathead Valley, Montana.

**Status: exploratory.** Nothing committed, nothing purchased. This is a scratchpad for figuring out whether the idea is worth doing.
...
- **DIY build cost:** ~$28,000–32,000 realistic midpoint
- **Licensed alternative:** $60,000 + $250/mo
...
Every number here is an estimate as of September 2026 and should be verified before anyone spends money. Tariff rates, trailer prices, and insurance quotes all move.

Don't reuse the "HOOP" name, shield logo, or blue-and-black color scheme from the existing network — they claim trademark. A different brand costs nothing.
